...
let mini_lunbotu_button = document.querySelector('.mini-lunbotu-button');
...
// //当鼠标移动到li中显示按钮
mini_lunbotu.onmouseenter = function() {
    mini_lunbotu_button.style.display = 'block';
    // 当鼠标进入li时停止定时器
    // clearInterval(timer_right_module);
}
// 当鼠标移出li隐藏
mini_lunbotu.onmouseleave = function() {
    mini_lunbotu_button.style.display = 'none';
    // 当鼠标移出开启定时器
    // timer_right_module = setInterval(auto_right_module,6000);
}
...
let inputTime = +new Date('2022-12-1 22:00:00');
